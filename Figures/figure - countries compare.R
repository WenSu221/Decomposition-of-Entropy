...
lines(Years,entropyCAL1,type = "b",col = 1,lty=1,lwd=1.5)
lines(Years,entropyCAL2,type = "b",col = 2,lty=5,lwd=1.5)
lines(Years,entropyCAL3,type = "b",col = 3,lty=5,lwd=1.5)
lines(Years,entropyCAL4,type = "b",col = 4,lty=5,lwd=1.5)
lines(Years,entropyCAL5,type = "b",col = 5,lty=5,lwd=1.5)
lines(Years2,entropyCAL6,type = "b",col = 6,lty=6,lwd=1.5)
