...
b <- barplot(decomp1,col = coul,border = "white",
             ...
             main = "Decomposition of entropy of CAL between Italy and average level,both 1989-2017",
...
b <- barplot(decomp1,col = coul,border = "white",
             ...
             main = "Decomposition of entropy of CAL between Italy and average level,both 1991-2015",
             sub = "source: Author's calculation based on HMD data")
...
lines(b,total,lwd=1.5)
points(b,total,pch=16)
mtext("average level", side = 2,adj = 0.9)
