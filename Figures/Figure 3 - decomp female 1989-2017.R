...
centropydiff_GBRTENW <- (entropydiff_GBRTENW[2:15]-entropydiff_GBRTENW[1:14])/4

centropyavg_GBRTENW <- (entropyavg_GBRTENW[2:15] - entropyavg_GBRTENW[1:14])/4
...
cvariation_GBRTENW <- (variation_GBRTENW[2:15]-variation_GBRTENW[1:14])/4
clongevity_GBRTENW <- (longevity_GBRTENW[2:15]-longevity_GBRTENW[1:14])/4
