...
### Data # ----
A1 <- read.table("Data/SWE.mltcoh_1x1.txt",header=TRUE,fill=TRUE,skip=1,colClasses = "character")
A2 <- read.table("Data/DNK.mltcoh_1x1.txt",header=TRUE,fill=TRUE,skip=1,colClasses = "character")
A3 <- read.table("Data/FRATNP.mltcoh_1x1.txt",header=TRUE,fill=TRUE,skip=1,colClasses = "character")
A4 <- read.table("Data/GBRTENW.mltcoh_1x1.txt",header=TRUE,fill=TRUE,skip=1,colClasses = "character")
A5 <- read.table("Data/NOR.mltcoh_1x1.txt",header=TRUE,fill=TRUE,skip=1,colClasses = "character")
A6 <- read.table("Data/FIN.mltcoh_1x1.txt",header=TRUE,fill=TRUE,skip=1,colClasses = "character")
A7 <- read.table("Data/ITA.mltcoh_1x1.txt",header=TRUE,fill=TRUE,skip=1,colClasses = "character")
A8 <- read.table("Data/GBRSCO.mltcoh_1x1.txt",header=TRUE,fill=TRUE,skip=1,colClasses = "character")
A9 <- read.table("Data/NLD.mltcoh_1x1.txt",header=TRUE,fill=TRUE,skip=1,colClasses = "character")
A10 <- read.table("Data/CHE.mltcoh_1x1.txt",header=TRUE,fill=TRUE,skip=1,colClasses = "character")
