...
png("Output/SWE_change_male.png", units = "in",width = 6,height = 8,res = 150)
...
png("Output/SWE_dod_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
...
png("Output/DNK_change_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "relative disparities",
...
png("Output/DNK_dod_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "contribution to changes in relative disparities",
...
png("Output/FRATNP_change_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "relative disparities",
...
png("Output/FRATNP_dod_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "contribution to changes in relative disparities",
...
png("Output/GBRTENW_change_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "relative disparities",
...
png("Output/GBRTENW_dod_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "contribution to changes in relative disparities",
...
png("Output/NOR_change_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "relative disparities",
...
png("Output/NOR_dod_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "contribution to changes in relative disparities",
...
png("Output/FIN_change_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "relative disparities",
...
png("Output/FIN_dod_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "contribution to changes in relative disparities",
...
png("Output/ITA_change_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "relative disparities",
...
png("Output/ITA_dod_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "contribution to changes in relative disparities",
...
png("Output/GBRSCO_change_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "relative disparities",
...
png("Output/GBRSCO_dod_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "contribution to changes in relative disparities",
...
png("Output/NLD_change_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "relative disparities",
...
png("Output/NLD_dod_male.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "contribution to changes in relative disparities",
