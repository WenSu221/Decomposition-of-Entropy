...
png("Output/DNK_change_female_G5.png", units = "in",width = 6,height = 8,res = 150)
...
png("Output/DNK_dod_female_G5.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
...
png("Output/FIN_change_female_G5.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "Relative disparities",
...
png("Output/FIN_dod_female_G5.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "Contribution to changes in relative disparities",
...
png("Output/NOR_change_female_G5.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "Relative disparities",
...
png("Output/NOR_dod_female_G5.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "Contribution to changes in relative disparities",
...
png("Output/ITA_change_female_G5.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "Relative disparities",
...
png("Output/ITA_dod_female_G5.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "contribution to changes in relative disparities",
...
png("Output/FRATNP_change_female_G5.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "Relative disparities",
...
png("Output/FRATNP_dod_female_G5.png", units = "in",width = 6,height = 8,res = 150)
b <- barplot(decomp1,col = coul,border = "white",
             ylim = myrange,
             xlab="Year",ylab = "Contribution to changes in relative disparities",
