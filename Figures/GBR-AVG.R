...
b <- barplot(decomp1,col = coul,border = "white",
             ...
             main = "Decomposition of entropy of CAL between England and Wales and average level,both 1989-2017",
...
decomp1[decomp1>0] <- 0
decomp2[decomp2<0] <- 0
myrange <- range(range(total),-0.00001)*1.2
...
b <- barplot(decomp1,col = coul,border = "white",
             ...
             main = "Decomposition of entropy of CAL between England and Wales and average level,both 1991-2015",
             sub = "source: Author's calculation based on HMD data")
