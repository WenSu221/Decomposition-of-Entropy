...
## Source
source("main/figure 4 - average of CAL male 1989-2017.R")
...
clongevity_relative_FRA <- log(longevity_FRA[2:30]/longevity_FRA[1:29])/2
clongevity_original_FRA <- longevity_FRA[1:29]*exp(1)^(clongevity_relative_FRA)
...
#change in entropy differences
centropydiff_relative_GBRTENW <- log(entropydiff_GBRTENW[2:30]/entropydiff_GBRTENW[1:29])/2
centropydiff_original_GBRTENW <- entropydiff_GBRTENW[1:29]*exp(1)^(centropydiff_relative_GBRTENW)
centropydiff_derivative_GBRTENW <- centropydiff_relative_GBRTENW*centropydiff_original_GBRTENW

#change in entropy average
centropyavg_relative_GBRTENW <- log(entropyavg_GBRTENW[2:30]/entropyavg_GBRTENW[1:29])/2
centropyavg_original_GBRTENW <- entropyavg_GBRTENW[1:29]*exp(1)^(centropyavg_relative_GBRTENW)
centropyavg_derivative_GBRTENW <- centropyavg_relative_GBRTENW*centropyavg_original_GBRTENW

#average in entropy difference
entropydiffavg_relative_GBRTENW <- log(entropydiff_GBRTENW[2:30]/entropydiff_GBRTENW[1:29])/2
entropydiffavg_original_GBRTENW <- entropydiff_GBRTENW[1:29]*exp(1)^(entropydiffavg_relative_GBRTENW)

#average in average in entropy
entropyavgavg_relative_GBRTENW <- log(entropyavg_GBRTENW[2:30]/entropyavg_GBRTENW[1:29])/2
entropyavgavg_original_GBRTENW <- entropyavg_GBRTENW[1:29]*exp(1)^(entropyavgavg_relative_GBRTENW)


cvariation_relative_GBRTENW <- log(variation_GBRTENW[2:30]/variation_GBRTENW[1:29])/2
cvariation_original_GBRTENW <- variation_GBRTENW[1:29]*exp(1)^(cvariation_relative_GBRTENW)
cvariation_derivative_GBRTENW <- cvariation_relative_GBRTENW*cvariation_original_GBRTENW

clongevity_relative_GBRTENW <- log(longevity_GBRTENW[2:30]/longevity_GBRTENW[1:29])/2
clongevity_original_GBRTENW <- longevity_GBRTENW[1:29]*exp(1)^(clongevity_relative_GBRTENW)
...
#change in entropy differences
centropydiff_relative_FIN <- log(entropydiff_FIN[2:30]/entropydiff_FIN[1:29])/2
centropydiff_original_FIN <- entropydiff_FIN[1:29]*exp(1)^(centropydiff_relative_FIN)
centropydiff_derivative_FIN <- centropydiff_relative_FIN*centropydiff_original_FIN

#change in entropy average
centropyavg_relative_FIN <- log(entropyavg_FIN[2:30]/entropyavg_FIN[1:29])/2
centropyavg_original_FIN <- entropyavg_FIN[1:29]*exp(1)^(centropyavg_relative_FIN)
centropyavg_derivative_FIN <- centropyavg_relative_FIN*centropyavg_original_FIN

#average in entropy difference
entropydiffavg_relative_FIN <- log(entropydiff_FIN[2:30]/entropydiff_FIN[1:29])/2
entropydiffavg_original_FIN <- entropydiff_FIN[1:29]*exp(1)^(entropydiffavg_relative_FIN)

#average in average in entropy
entropyavgavg_relative_FIN <- log(entropyavg_FIN[2:30]/entropyavg_FIN[1:29])/2
entropyavgavg_original_FIN <- entropyavg_FIN[1:29]*exp(1)^(entropyavgavg_relative_FIN)


cvariation_relative_FIN <- log(variation_FIN[2:30]/variation_FIN[1:29])/2
cvariation_original_FIN <- variation_FIN[1:29]*exp(1)^(cvariation_relative_FIN)
cvariation_derivative_FIN <- cvariation_relative_FIN*cvariation_original_FIN

clongevity_relative_FIN <- log(longevity_FIN[2:30]/longevity_FIN[1:29])/2
clongevity_original_FIN <- longevity_FIN[1:29]*exp(1)^(clongevity_relative_FIN)
