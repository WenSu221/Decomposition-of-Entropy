...
text(1950,0.085,eeqn2,col="forestgreen",cex=1.1)
text(1950,0.060,"piecewise value: 1957.134",col="forestgreen",cex=1.1)
...
title("Figure 1B. Time trends in period, cohort, and CAL entropy for male in selected populations, 1878-2018")
legend("topright"
