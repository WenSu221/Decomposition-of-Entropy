...
centropydiff_relative_SWE <- log(entropydiff_SWE[2:15]/entropydiff_SWE[1:14])/4
...
centropyavg_relative_SWE <- log(entropyavg_SWE[2:15]/entropyavg_SWE[1:14])/4
...
entropydiffavg_relative_SWE <- log(entropydiff_SWE[2:15]/entropydiff_SWE[1:14])/4
entropydiffavg_original_SWE <- entropydiff_SWE[1:14]*exp(1)^(entropydiffavg_relative_SWE)

#average in average in entropy
entropyavgavg_relative_SWE <- log(entropyavg_SWE[2:15]/entropyavg_SWE[1:14])/4
entropyavgavg_original_SWE <- entropyavg_SWE[1:14]*exp(1)^(entropyavgavg_relative_SWE)


cvariation_relative_SWE <- log(variation_SWE[2:15]/variation_SWE[1:14])/4
...
clongevity_relative_SWE <- log(longevity_SWE[2:15]/longevity_SWE[1:14])/4
...
centropydiff_DNK <- (entropydiff_DNK[2:15]-entropydiff_DNK[1:14])/4

centropyavg_DNK <- (entropyavg_DNK[2:15] - entropyavg_DNK[1:14])/4
...
cvariation_DNK <- (variation_DNK[2:15]-variation_DNK[1:14])/4
clongevity_DNK <- (longevity_DNK[2:15]-longevity_DNK[1:14])/4
...
#change in entropy differences
centropydiff_relative_FRA <- log(entropydiff_FRA[2:15]/entropydiff_FRA[1:14])/4
...
#change in entropy average
centropyavg_relative_FRA <- log(entropyavg_FRA[2:15]/entropyavg_FRA[1:14])/4
...
#average in entropy difference
entropydiffavg_relative_FRA <- log(entropydiff_FRA[2:15]/entropydiff_FRA[1:14])/4
entropydiffavg_original_FRA <- entropydiff_FRA[1:14]*exp(1)^(entropydiffavg_relative_FRA)

#average in average in entropy
entropyavgavg_relative_FRA <- log(entropyavg_FRA[2:15]/entropyavg_FRA[1:14])/4
entropyavgavg_original_FRA <- entropyavg_FRA[1:14]*exp(1)^(entropyavgavg_relative_FRA)

#longevity and variation components
cvariation_relative_FRA <- log(variation_FRA[2:15]/variation_FRA[1:14])/4
...
#change in entropy differences
centropydiff_relative_GBRTENW <- log(entropydiff_GBRTENW[2:15]/entropydiff_GBRTENW[1:14])/4
...
#change in entropy average
centropyavg_relative_GBRTENW <- log(entropyavg_GBRTENW[2:15]/entropyavg_GBRTENW[1:14])/4
...
#average in entropy difference
entropydiffavg_relative_GBRTENW <- log(entropydiff_GBRTENW[2:15]/entropydiff_GBRTENW[1:14])/4
entropydiffavg_original_GBRTENW <- entropydiff_GBRTENW[1:14]*exp(1)^(entropydiffavg_relative_GBRTENW)

#average in average in entropy
entropyavgavg_relative_GBRTENW <- log(entropyavg_GBRTENW[2:15]/entropyavg_GBRTENW[1:14])/4
entropyavgavg_original_GBRTENW <- entropyavg_GBRTENW[1:14]*exp(1)^(entropyavgavg_relative_GBRTENW)


cvariation_relative_GBRTENW <- log(variation_GBRTENW[2:15]/variation_GBRTENW[1:14])/4
...
clongevity_relative_GBRTENW <- log(longevity_GBRTENW[2:15]/longevity_GBRTENW[1:14])/4
...
#change in entropy differences
centropydiff_relative_NOR <- log(entropydiff_NOR[2:15]/entropydiff_NOR[1:14])/4
...
#change in entropy average
centropyavg_relative_NOR <- log(entropyavg_NOR[2:15]/entropyavg_NOR[1:14])/4
...
#average in entropy difference
entropydiffavg_relative_NOR <- log(entropydiff_NOR[2:15]/entropydiff_NOR[1:14])/4
entropydiffavg_original_NOR <- entropydiff_NOR[1:14]*exp(1)^(entropydiffavg_relative_NOR)

#average in average in entropy
entropyavgavg_relative_NOR <- log(entropyavg_NOR[2:15]/entropyavg_NOR[1:14])/4
entropyavgavg_original_NOR <- entropyavg_NOR[1:14]*exp(1)^(entropyavgavg_relative_NOR)


cvariation_relative_NOR <- log(variation_NOR[2:15]/variation_NOR[1:14])/4
...
clongevity_relative_NOR <- log(longevity_NOR[2:15]/longevity_NOR[1:14])/4
...
#change in entropy differences
centropydiff_relative_ITA <- log(entropydiff_ITA[2:15]/entropydiff_ITA[1:14])/4
...
#change in entropy average
centropyavg_relative_ITA <- log(entropyavg_ITA[2:15]/entropyavg_ITA[1:14])/4
...
#average in entropy difference
entropydiffavg_relative_ITA <- log(entropydiff_ITA[2:15]/entropydiff_ITA[1:14])/4
entropydiffavg_original_ITA <- entropydiff_ITA[1:14]*exp(1)^(entropydiffavg_relative_ITA)

#average in average in entropy
entropyavgavg_relative_ITA <- log(entropyavg_ITA[2:15]/entropyavg_ITA[1:14])/4
entropyavgavg_original_ITA <- entropyavg_ITA[1:14]*exp(1)^(entropyavgavg_relative_ITA)

#longevity and variation components
cvariation_relative_ITA <- log(variation_ITA[2:15]/variation_ITA[1:14])/4
...
clongevity_relative_ITA <- log(longevity_ITA[2:15]/longevity_ITA[1:14])/4
...
#change in entropy differences
centropydiff_relative_GBRSCO <- log(entropydiff_GBRSCO[2:15]/entropydiff_GBRSCO[1:14])/4
...
#change in entropy average
centropyavg_relative_GBRSCO <- log(entropyavg_GBRSCO[2:15]/entropyavg_GBRSCO[1:14])/4
...
#average in entropy difference
entropydiffavg_relative_GBRSCO <- log(entropydiff_GBRSCO[2:15]/entropydiff_GBRSCO[1:14])/4
entropydiffavg_original_GBRSCO <- entropydiff_GBRSCO[1:14]*exp(1)^(entropydiffavg_relative_GBRSCO)

#average in average in entropy
entropyavgavg_relative_GBRSCO <- log(entropyavg_GBRSCO[2:15]/entropyavg_GBRSCO[1:14])/4
entropyavgavg_original_GBRSCO <- entropyavg_GBRSCO[1:14]*exp(1)^(entropyavgavg_relative_GBRSCO)

#longevity and variation components
cvariation_relative_GBRSCO <- log(variation_GBRSCO[2:15]/variation_GBRSCO[1:14])/4
...
clongevity_relative_GBRSCO <- log(longevity_GBRSCO[2:15]/longevity_GBRSCO[1:14])/4
...
#change in entropy differences
centropydiff_relative_NLD <- log(entropydiff_NLD[2:15]/entropydiff_NLD[1:14])/4
...
#change in entropy average
centropyavg_relative_NLD <- log(entropyavg_NLD[2:15]/entropyavg_NLD[1:14])/4
...
#average in entropy difference
entropydiffavg_relative_NLD <- log(entropydiff_NLD[2:15]/entropydiff_NLD[1:14])/4
entropydiffavg_original_NLD <- entropydiff_NLD[1:14]*exp(1)^(entropydiffavg_relative_NLD)

#average in average in entropy
entropyavgavg_relative_NLD <- log(entropyavg_NLD[2:15]/entropyavg_NLD[1:14])/4
entropyavgavg_original_NLD <- entropyavg_NLD[1:14]*exp(1)^(entropyavgavg_relative_NLD)


cvariation_relative_NLD <- log(variation_NLD[2:15]/variation_NLD[1:14])/4
...
clongevity_relative_NLD <- log(longevity_NLD[2:15]/longevity_NLD[1:14])/4
